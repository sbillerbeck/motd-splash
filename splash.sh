...
if [ ! -f "$HOME/.splash_off" ]; then
shuf -n 1 << 'EOF' | envsubst |  xargs echo -e
$USER IS YOU!
"\033[34mC\033[32mo\033[32ml\033[31mo\033[31mr\033[33mm\033[37ma\033[35mt\033[35mi\033[32mc!\033[0m"
Better than Prey!
Alpha version!
As seen on TV!
Awesome!
